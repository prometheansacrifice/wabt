...
class BinaryReaderNop : public BinaryReaderDelegate {
 public:
  ...
  Result OnTableGetExpr(Index table_index_index) override { return Result::Ok; }
  Result OnTableSetExpr(Index table_index_index) override { return Result::Ok; }
  Result OnTableGrowExpr(Index table_index_index) override { return Result::Ok; }
