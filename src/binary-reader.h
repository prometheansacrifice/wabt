...
class BinaryReaderDelegate {
 public:
  ...
  virtual Result OnTableGetExpr(Index table_index_index) = 0;
  virtual Result OnTableSetExpr(Index table_index_index) = 0;
  virtual Result OnTableGrowExpr(Index table_index_index) = 0;
